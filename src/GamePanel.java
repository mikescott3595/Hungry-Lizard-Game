 ...
 * 
 *         Responsibilities of class: The main JPanel that draws the
 *         game(background, entities, UI elements)
 */
public class GamePanel extends JPanel implements KeyListener
{
	...
	/**
	 * Inserts the background image of the game and adjusts opacity
	 */
	@Override
	...
	/**
	 * Returns the playable Lizard
	 * 
	 * @return lizard player
	 */
	...
	*/
	...
	/**
	 * Saves the score of a game to a file
	 */
